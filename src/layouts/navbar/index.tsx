...
export function LpNavbar() {
  ...
  return (
    <nav className="border-border bg-background/80 sticky top-0 z-50 mx-auto w-full border-b px-6 py-2.5 backdrop-blur-md md:top-6 md:max-w-7xl md:rounded-xl md:border md:p-3 md:shadow-lg">
